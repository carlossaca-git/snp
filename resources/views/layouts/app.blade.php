        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="#!">Iniciar
                            sesion</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-md-4 mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer"><a class="btn btn-outline-primary btn-sm" href="#!">Leer mas</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer">
                                <a target="_blank" class="btn btn-outline-primary btn-sm" href="https://bit.ly/4scKbXW">Leer mas</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer"><a target="_blank" class="btn btn-outline-primary btn-sm" href="https://bit.ly/4p591pV">Leer mas</a>
                            </div>
                        </div>
                    </div>
                </div>
