        ...
        <form action="{{ route('admin.usuarios.update', $user->id_usuario) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2 bg-gray-50 p-4 rounded border">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input type="password" name="password" placeholder="Nueva contraseña" autocomplete="new-password" class="border rounded p-2">
                        <input type="password" name="password_confirmation" placeholder="Confirmar nueva contraseña" autocomplete="new-password" class="border rounded p-2">
                    </div>
                </div>
            </div>

            <div class="mt-6 flex justify-between">
                <a href="{{ route('admin.usuarios.index') }}" class="text-gray-600 underline">Cancelar</a>
