                ...
                <div class="card-body p-4 position-relative">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex flex-column align-items-start gap-3">
                            ...
                            <form action="{{ route('estrategico.organizaciones.destroy', $organizacion->id_organizacion) }}"
                                method="POST"
                                        ...
                                        <td class="text-center">
                                            @if ($obj->alineacion && $obj->alineacion->ods)
                                                <div class="d-inline-block text-center shadow-sm rounded p-1"
                                                    ...
                                                    <span
                                                        class="text-white fw-bold h5 mb-0">{{ $obj->alineacion->ods->numero }}</span>
                                                </div>
                                            @else
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm bg-primary text-white mb-4 overflow-hidden position-relative">
                ...
                <div class="card-body text-center py-4">
                    <h1 class="display-3 fw-bold mb-0">{{ $alineaciones->count() }}</h1>
