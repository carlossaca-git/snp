...
@section('content')
    ...
    <div class="container mx-auto py-5">
        ...
        @if ($errors->any())
            <div class="alert alert-danger shadow-sm border-0 mb-4">
                <div class="fw-bold"><i data-feather="alert-circle" class="me-2"></i>Por favor, corrige los siguientes errores:</div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="roles[]" class="form-select @error('roles') is-invalid @enderror" required>
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->id_rol }}" {{ (is_array(old('roles')) && in_array($role->id_rol, old('roles'))) ? 'selected' : '' }}>
                                        {{ $role->nombre }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <button type="button" onclick="generatePassword()" class="btn btn-outline-primary" title="Generar clave segura">
    ...
    <script>
        function generatePassword() {
            ...
            passField.type = 'text';
            setTimeout(() => { passField.type = 'password'; }, 5000); // 5 segundos
        }
