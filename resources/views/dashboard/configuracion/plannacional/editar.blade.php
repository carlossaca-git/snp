            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('catalogos.planes-nacionales.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('periodo_inicio') is-invalid @enderror"
                                       ...
                                       value="{{ old('periodo_inicio', date('Y')) }}" min="2000" max="2100" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('periodo_fin') is-invalid @enderror"
                                       id="periodo_fin" name="periodo_fin"
                                       value="{{ old('periodo_fin', date('Y')+4) }}" min="2000" max="2100" required>
                                @error('periodo_fin')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            <label for="registro_oficial" class="form-label fw-bold">Registro Oficial / Decreto (Opcional)</label>
                        ...
                        <div class="alert alert-warning d-flex align-items-center" role="alert">
                            ...
                            <div>
                                ...
                                Podrás activarlo desde el listado principal una vez verifiques los datos.
                            </div>
                        </div>

                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="{{ route('catalogos.planes-nacionales.index') }}" class="btn btn-light border">Cancelar</a>
